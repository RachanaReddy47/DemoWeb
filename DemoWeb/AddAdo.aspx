<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster1.Master" AutoEventWireup="true" CodeBehind="AddAdo.aspx.cs" Inherits="DemoWeb.Ado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>
            <asp:Button ID="Button1" runat="server" Text="Add" OnClick="Button1_Click" Width="121px" OnClientClick="return Add();" /></td>
    
        <td>
            <asp:Button ID="Button2" runat="server" Text="Insert with SP" OnClick="Button2_Click" />
        </td>
        </tr>
    </table>
</asp:Content>
