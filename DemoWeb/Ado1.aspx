<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster1.Master" AutoEventWireup="true" CodeBehind="Ado1.aspx.cs" Inherits="DemoWeb.Ado1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr><td>
        <asp:RadioButton ID="rdbDeptno" runat="server" GroupName="G1" Text="Deptno" AutoPostBack="True" OnCheckedChanged="rdbDeptno_CheckedChanged" />
         ...
         <tr>
             <td>
                 <asp:Button ID="btnExtract" runat="server" Text="Extract EF" Width="128px" OnClick="btnExtract_Click" />
             </td>
         </tr>
